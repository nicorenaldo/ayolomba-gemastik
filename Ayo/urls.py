...
urlpatterns = [
    ...
    path('dashboard/', accounts_views.profile, name='dashboard'),
    path('settings/', accounts_views.settings, name='settings'),
    path('about/', competitions.about, name='about'),
    
    re_path(r'^taggit_autosuggest/', include('taggit_autosuggest.urls')),

    
    path('',competitions.home, name='home'),
...
handler404 = 'competitions.views.handler404'
